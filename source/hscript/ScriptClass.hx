...
class ScriptClass {
    ...
    private var interpNameToLog:String;
    public function new(name:String, dir:String, c:ClassDeclEx, args:Array<Dynamic>) {
        _c = c;
        _interp = new InterpEx(name, dir, this);
        buildCaches();

        interpNameToLog = name;
    ...
    private function createSuperClass(args:Array<Dynamic> = null) {
        ...
        if (classDescriptor != null) {
            var abstractSuperClass:AbstractScriptClass = new ScriptClass(interpNameToLog, @:privateAccess _interp.dir, classDescriptor, args);
