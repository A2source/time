...
class FlxTween implements IFlxDestroyable
{
	 ...
	 */
	public static function tween(Object:Dynamic, Values:Dynamic, Duration:Float = 1, ?Options:TweenOptions, ?Name:String = ''):VarTween
	{
		return globalManager.tween(Object, Values, Duration, Options, Name);
	}
...
class FlxTweenManager extends FlxBasic
{
	 ...
	 * @since   4.2.0
	 */
	public function tween(Object:Dynamic, Values:Dynamic, Duration:Float = 1, ?Options:TweenOptions, ?Name:String = ''):VarTween
	{
